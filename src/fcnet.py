...
class FullyConnectedNet(object):
   ...
   """
   def __init__(self, hidden_dims, input_dim=32*32*3, num_classes=10, dropout=0, reg=0.0, weight_scale=1e-2, dtype=np.float32, seed=None):
      """
...
def loss(self, X, y=None):
   ...
   Returns: If y is None, then run a test-time forward pass of the model and
   return:
